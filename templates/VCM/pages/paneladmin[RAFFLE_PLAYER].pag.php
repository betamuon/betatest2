<h6 class="red">&raquo; Sortear Jogador</h6>
	   <blockquote>
<form name="Raffle_Player" id="Raffle_Player">
<table border="0" width="340">
  <tr>
    <td width="170"><strong>Moeda a ser premiada:</strong></td>
    <td width="160"><select name="Moeda" id="Moeda">
  ...
  <tr>
    <td width="170"><strong>Quantidade a ser Premiado:</strong></td>
    <td width="160"><input type="text" name="Golds" id="Golds" size="5" maxlength="8" /></td>
  </tr>
</table>
<br />
