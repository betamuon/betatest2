...
<div class="box">
<h6 class="red">&raquo; Alterar E-Mail</h6>
<blockquote>
...
<table width="340" border="0">
  ...
  ?>
  <tr>
    <td width="151">Codigo de Valida&ccedil;&atilde;o:</td>
    <td width="179"><input type="text" name="Code" id="Code" onKeyUp="this.value = this.value.toLowerCase();" maxlength="32" /
 /></td>
  </tr>
  <? } ?>
  <tr>
    <td width="151">E-Mail Atual:</td>
    <td width="179"><input type="text" name="Old_Mail" id="Old_Mail" /></td>
  </tr>
  <tr>
    <td width="151">Novo E-Mail:</td>
    <td width="179"><input type="text" name="New_Mail" id="New_Mail" /></td>
  </tr>
  <tr>
    <td width="151">Confirmar E-Mail:</td>
    <td width="179"><input type="text" name="Re_Mail" id="Re_Mail" /></td>
  </tr>
  <tr>
