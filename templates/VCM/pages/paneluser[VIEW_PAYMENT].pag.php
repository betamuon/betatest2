<h6 class="red">&raquo; Pagamento {Payment_Post#Date}</h6>
	<blockquote>
	<table border="0" width="280">
 			 <tr>
   			 <td width="125"><img src="{Payment_Char#Image}" width="110" height="110" style="border: 1px solid #B3B3B3;" class="image" /></td>
        ...
        {Payment_Resp}
		<h6 class="red">&raquo; Responder</h6>
	<blockquote>
...
<table width="280" border="0">
      ...
      <tr>
        <td align="center" colspan="33"><textarea name="Text" id="Text" cols="60" rows="7"></textarea><br />&nbsp;</td>
      </tr>
      <tr>
        <td align="center" colspan="33"><input type="button" value="Responder" onclick="CTM_Load('?pag=paneluser&str=VIEW_PAYMENT&cmd=true&id={Payment_ID}','Command','POST',BuscaElementosForm('Resp_Payment'));" /></td>
      </tr>
	  </table>
	  </form>
	  </blockquote>
