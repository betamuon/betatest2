<h6 class="red">&raquo; Distribuir Pontos</h6>
	   <blockquote>
	   <div style="padding:5px 10px;"><b class="colr">- Seu Status atual &eacute;:</b><br /><br />
...
<table width="340" border="0">
  <tr>
    <td width="140">Força:</td>
    <td width="190"><input type="text" name="Strength" id="Strength" onKeyPress="return NumbersOnly(event)" maxlength="5" /></td>
  </tr>
  <tr>
    <td>Agilidade:</td>
