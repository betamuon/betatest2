...
<h6 class="red">&raquo; Gerenciar Membros</h6>
	   <blockquote>
	   <form name="Manage_Members" id="Manage_Members">
		   <strong>Nome:</strong> <select name="Id" id="Id">
			{Members_List}
		</select>&nbsp;<br /><input type="button" value="Editar" onclick="CTM_Load('?pag=paneladmin&str=EDIT_MEMBER','While','POST',BuscaElementosForm('Manage_Members'));" />&nbsp;<input type="button" value="Deletar Membro" onclick="Delete_Member()" />
		   </form>
	</blockquote>
	<div id="While"></div>