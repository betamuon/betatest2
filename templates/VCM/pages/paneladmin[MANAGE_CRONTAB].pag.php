...
<h6 class="red">&raquo; Gerenciar CronTabs</h6>
	   <blockquote>
       <form name="Manage_CronTab" id="Manage_CronTab">
		   <strong>Noticia:</strong> <select name="Id" id="Id">
			{CronTab_List}
		</select>&nbsp;<br /><input type="button" value="Editar" onclick="CTM_Load('?pag=paneladmin&str=EDIT_CRONTAB','While','POST',BuscaElementosForm('Manage_CronTab'));" />&nbsp;<input type="button" value="Deletar CronTab" onclick="Delete_CronTab()" />
		   </form>
	</blockquote>
	<div id="While"></div>