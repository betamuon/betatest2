<div id="Close_Ticket">
<h6 class="red">&raquo; Responder Ticket</h6>
	<blockquote>
...
<table width="452" border="0">
      ...
      <tr>
        <td align="center" colspan="33"><input type="button" value="Responder Ticket" onclick="CTM_Load('?pag=paneluser&str=VIEW_TICKET&cmd=true&id={Ticket_ID}','Command','POST',BuscaElementosForm('Resp_Ticket'));" />&nbsp;<input type="button" value="Fechar Ticket" onclick="Close_Ticket();" /></td>
      </tr>
	  </table>
	  </form>
	  </blockquote>
