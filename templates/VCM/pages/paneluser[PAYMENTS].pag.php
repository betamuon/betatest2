<h6 class="red">&raquo; Pagamentos</h6>
	   <blockquote>
	   <div id="TabbedPanels1" class="TabbedPanels" style="width:340px !important;">
  ...
  <div class="TabbedPanelsContentGroup">
	...
	<form name="Confirm_Paymet" id="Confirm_Payment">
	   <h6 class="red">&raquo; Dados da Compra</h6>
  ...
  <h6 class="red">&raquo; Mensagem</h6>
  <table width="340" border="0">
  <tr align="center">
      ...
      <tr>
        <td align="center" colspan="33"><textarea name="Text" id="Text" cols="60" rows="7">Ira Adiquirir algum Plano Vip/Super Vip ? Se Sim Qual ?</textarea><br />&nbsp;</td>
      </tr>
      <tr>
        <td align="center" colspan="33"><input type="button" value="Confirmar Pagamento" onclick="CTM_Load('?pag=paneluser&str=PAYMENTS&exec=true','Command','POST',BuscaElementosForm('Confirm_Payment'));" /></td>
      </tr>
  </table>
  </form>
    </div>
