...
<h6 class="red">&raquo; Pagamento {Payment_Post#Date}</h6>
	...
	<table border="0" width="340">
 			 <tr>
   			 <td width="132"><img src="{Payment_Char#Image}" width="120" height="120" style="border: 1px solid #B3B3B3;" class="image" /></td>
   			 <td width="496"><table border="0">
				 <tr>
