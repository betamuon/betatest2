...
<div id="Verify" style="display: none;"></div>
	<h6 class="red">&raquo; Editar Dados</h6>
	<blockquote>
            	<form name="Account_Dates" id="Account_Dates">
<table width="340" border="0">
  <tr>
    <td width="127">Nome:</td>
    <td width="203"><input type="text" name="Name" id="Name" value="{Account_Name}" /></td>
  </tr>
  <tr>
    <td>E-Mail:</td>
...
<h6 class="red">&raquo; Alterar Senha</h6>
<blockquote>
...
<table width="340" border="0">
  ...
  <tr>
    ...
    <td width="190"><input type="password" name="Password" id="Password" maxlength="10" onKeyUp="PasswordLevel('Password');" /><span id="PasswordResult"></span></td>
  </tr>
  <tr>
