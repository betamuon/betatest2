...
<h6 class="red">&raquo; Alterar Nick</h6>
	   <blockquote>
	  <p>Seu Nick atual &eacute; <b>{Manage_Character}</b>.</p><br />
<form name="New_Nick" id="New_Nick">
<table width="340" border="0">
  <tr>
    <td width="152">Novo Nick:</td>
    <td width="178"><input type="text" name="Nick" id="Nick" maxlength="10" /></td>
  </tr>
  <tr>
...
<b class="colr">Deseja alterar seu Nick?</b><br />
