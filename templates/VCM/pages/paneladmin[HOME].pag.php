<h6 class="red">&raquo; Informa&ccedil;&otilde;es</h6>
	   <blockquote>
	   <div id="TabbedPanels1" class="TabbedPanels" style="width:345px !important;">
  <ul class="TabbedPanelsTabGroup" style="font-size: 13px;">
    <li class="TabbedPanelsTab" tabindex="0">Informa&ccedil;&otilde;es da Hosp.</li>
    <li class="TabbedPanelsTab" tabindex="0">Informa&ccedil;&otilde;es do Server</li>
  ...
  <tr>
    <td width="174">&raquo; Sistema Operacional:</td>
    <td width="156"><strong>{Operation_System}</strong></td>
  </tr>
  <tr>
  ...
  <? } ?>
	...
	<div class="TabbedPanelsContent">
	          <table width="340" border="0" style="font-size: 12px;">
  <tr>
    <td>Nome:</td>
