<?php
//Slides
define("L_Slide", true); // -- Mostrar Slide na página principal? (true=sim / false=não)
...
define("L_LinkSl  -- Link do 3º slide
...
define("L_KingOfPVP", "BetaMuOnline"); // -- Rei do PVP
define("L_CharKingOfPVP", "BetaMu"); // -- Personagem Rei do PVP
define("L_CharUFC", "BetaMu"); // -- Personagem UFC MU
...
define("TUKKER_DoadorMes", "BetaMu"); // -- Opção Template TUKKER --- DoadorMes
...
*****************************************************************************/
$_Mailer["SMTP"]["Server"] = "smtp.betamu.com.br"; // -- Host do Servidor SMTP (Padrão -> localhost)
...
define("NEWFINAL_REF_LINK", "http://www.betamu.com.br/?ref="); // -- Link de referência

/*****************************************************************************
	@ Template Settings
	@ Configurações do Sistema de Template
	@ Para o template Padrão deixe "VCM"
*****************************************************************************/
define("Template_Default", "VCM"); // -- Nome da pasta do Template na pasta "templates" (Template Padrão)
...
##################################################################
$_Templates = array(0 => array("VCM", "VCM"),
					1 => array("VCM", "VCM"),
				   );
...
/*****************************************************************************
	...
	@ false = Não
*****************************************************************************/
define("Server_Name", "BetaMuOnline"); // -- Nome do Servidor
define("Web_Title", "Beta MuOnline Hard"); // -- Titulo do Site
define("Server_Version", "1.02n Season 2.4 ++"); // -- Versão do Servidor
define("Server_Xp", "100x"); // -- Experiência do Servidor
...
$_RaffleSystem["Accounts"] = array("tchong", "tchong"); // -- Contas com permisão de gerenciar o sistema (Exemplo: "admin","adm2")
$_RaffleSystem["Raffle"] = array("tchong", "tchong"); // -- Contas com permisão para sortear jogadores (Exemplo: "admin","adm2")
$_RaffleSystem["Clear"] = array("tchong", "tchong"); // -- Contas com permisão para limpar a lista de sorteados (Exemplo: "admin","adm2")
...
define("Register[VIP][Enable]", FALSE); // -- Ganhar VIP ao se Cadastrar (Padrão -> true)
...
define("Register[Cash][Number]", 200); // -- Quantidade de Cash a Ganhar
...
define("Forum_Link", "http://www.betamu.com.br/"); // -- Link do Fórum
...
define("Suportt_Phone", false); // -- Ativar/Desativar Suporte via telefone
##################################################################
	# E-Mails de Suporte
	# Exemplo: 0 => array("E-Mail", "Atendente"),
##################################################################
$_Suportt["Mail"] = array(0 => array("jeffe118752@gmail.com", "ADMIN"),
			   			  1 => array("GM", "GM"),
						  );
##################################################################
...
$_Panel["Account"]["Change_PID"] = array(0 /* Ativado */); // -- Alterar Personal ID (PID)
...
$_Panel["Account"]["ReferenceLink"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Link de Referência
...
$_Panel["Char"]["Transfer_Resets"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Master Reset
...
$_Panel["Char"]["Change_Class"] = array(0 /* Ativado */,0 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Alterar Classe
$_Panel["Char"]["Change_Nick"] = array(0 /* Ativado */,1 /* Free */,0 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Alterar Nick
$_Panel["Char"]["Move_Char"] = array(0 /* Ativado */,0 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Mover Personagem
...
$_Panel["Char"]["Concert_Points"] = array(0 /* Ativado */,0 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Concertar Pontos
$_Panel["Char"]["Reset_Points"] = array(0 /* Ativado */,0 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Resetar Pontos
$_Panel["Char"]["Distribute_Points"] = array(1 /* Ativado */,0 /* Free */,0 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Distribuir Pontos
$_Panel["Char"]["Clear_Char"] = array(0 /* Ativado */,0 /* Free */,0 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Limpar Personagem
...
*******************************************************/
$_Panel["Char"]["Reset"]["General"]["Mode"] = 0; // -- Modulo de Reset
...
$_Panel["Char"]["Trade_RCash"]["Coin"] = 3; // -- Moeda a receber (1 a 3)
$_Panel["Char"]["Trade_RCash"]["Price"] = 10; // -- Preço de cada Moeda em Resets
$_Panel["Char"]["Trade_RCash"]["Min_Total"] = 10; // -- Numero minimo de Resets que o char deve conter
...
/*****************************************************************************
	...
	@ 3 = Administrador
*****************************************************************************/
$_PanelAdmin["General"]["Master"] = array("tchong", "");// -- Contas Admin Master (Exemplo: "admin","adm2")
$_PanelAdmin["ManageX"] = 1; // -- Permissão minima para Gerenciamento Geral
$_PanelAdmin["Mail"] = 1; // -- Enviar E-Mail ao Jogador
$_PanelAdmin["Warning"] = 1; // -- Permissão minima para Gerenciar o Aviso Importante
$_PanelAdmin["News"] = 1; // -- Permissão minima para Gerenciar Noticias
$_PanelAdmin["ScreenShots"] = 1; // -- Permissão minima para Gerenciar ScreenShots (Deletar)
$_PanelAdmin["Downloads"] = 1; // -- Permissão minima para Gerenciar Downloads
$_PanelAdmin["Staff"] = 1; // -- Permissão minima para Gerenciar a Equipe
$_PanelAdmin["Poll"] = 1; // -- Permissão minima para gerenciar Enquetes
$_PanelAdmin["Account"] = 1; // -- Permissão minima para Gerenciar Contas
$_PanelAdmin["Character"] = 1; // -- Permissão minima para Gerenciar Chars
$_PanelAdmin["Reference"] = 1; // -- Permissão minima para Gerenciar Referência
$_PanelAdmin["Tickets"] = 1; // -- Permissão minima para Gerenciar Tickets de Suporte
$_PanelAdmin["Payments"] = 1; // -- Permissão minima para Gerenciamento de Pagamentos
$_PanelAdmin["VIP"] = 1; // -- Permissão minima para Gerenciar VIP
$_PanelAdmin["Cash"] = 1; // -- Permissão minima para Gerenciar Golds
$_PanelAdmin["SQL"] = 1; // -- Permissão minima para Gerenciar o SQL
$_PanelAdmin["RaffleSystem"] = 1; // -- Permissão minima para Gerenciar o sistema de Sorteio
...
$_PanelAdmin["Manage"]["EffectWeb"] = array("tchong", "", ); // -- Contas com permisão de gerenciar Licença da Effect Web (Exemplo: "admin","adm2")

/************ Configurações do Gerenciamento do CronJob ************/
$_PanelAdmin["CronbJob"]["Security"] = array("tchong", "", ); // -- Contas com permisão de gerenciar o CronJob (Exemplo: "admin","adm2")

/************ Configurações do Gerenciar Contas ************/
$_PanelAdmin["Accounts"]["Manage"] = 1; // -- Permisão minima para Gerenciar Contas
...
$_PanelAdmin["Characters"]["Create"] = 1; // -- Permisão minima para Criar Personagens
$_PanelAdmin["Characters"]["Manage"] = 1; // -- Permisão minima para Editar Personagens
...
$_PanelAdmin["Ticket"]["Delete"] = 1; // -- Permisão minima para deletar Tickets
...
$_PanelAdmin["Payment"]["Delete"] = 1; // -- Permisão minima para deletar Pagamentos

/************ Configurações do Gerenciar VIP ************/
$_PanelAdmin["VIPs"]["All"] = 1; // -- Permisão minima para adicionar VIP em todas as contas Free
