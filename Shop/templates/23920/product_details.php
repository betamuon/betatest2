                    ...
                    <script>
                          function refresh_price(){ 
                            ...
                            if(ancient > 0) {
                                ...
                                document.getElementById('ProductName').innerHTML = '{#ProductNameAncient}';    
                               ...
                               <table border="0">
                                ...
                                <tr>
                                 <td><label>Ancient: <select name="Item_Ancient" id="Item_Ancient" onchange="javascript: refresh_price();" {#DisabledAncient}>
                                                        ...
                                                        <option value='1'>+5 Stamina</option>
                                                        <option value='2'>+10 Stamina</option>
                                                     </select></label>
                                 </td>
                                </tr> 
                                <tr>
