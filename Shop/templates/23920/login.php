					...
					<div class="wrapper-center">
						<div class="clear contentpaneopen">
							<div class="fleft contentheading">
							   <div class="title">Beta Shop autom&aacute;tico</div>
							</div>
						</div>
					</div>
				</div>   
...
<input type="hidden" name="email_cobranca" value="luan@superhosty.com.br" />
