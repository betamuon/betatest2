	...
	<td valign="top">
					...
					<div class="wrapper-center">
						<div class="clear contentpaneopen">
							<div class="fleft contentheading">
							   <div class="title">Produtos da loja</div>
							</div>
						</div>
					</div>
				</div>   
        ...
        <div class="content-text">
			...
			<div class="quadros">
                ...
                <option value="Ofert">--- Promo&ccedil;&otilde;es
                <option value="All">--- Todos os Itens
                <option value="Kits">--- Kits
                <option value="0">- Defesa
                <option value="Helms">--- Helms
                <option value="Pants">--- Pants
                <option value="Gloves">--- Gloves
                <option value="Boots">--- Boots
                <option value="Armors">--- Armors
                <option value="Shields">--- Shields
                <option value="Pendants">--- Pendants
                <option value="Rings">--- Rings
                <option value="Wings">--- Wings
                <option value="0">- Ataque
                <option value="Axes">--- Axes
                <option value="Bows">--- Bows
                <option value="Crossbows">--- Crossbows
                <option value="Maces">--- Maces
                <option value="Scepters">--- Scepters
                <option value="Spears">--- Spears
                <option value="Staffs">--- Staffs
                <option value="Swords">--- Swords
                <option value="0">- Outros
                <option value="Gifts/Boxs">--- Gifts/Boxs
                <option value="Guards/Pets">--- Guards/Pets
                <option value="Jewels">--- Jewels
...
<td>                                                                        <?php
                ...
                <div class="box-content">
                  <div class="clear">
                    <ul class="menu">
                        ...
                        <li class="item64"><a href="?cmd=AboutSystem"><span>Sobre
                              a loja</span></a></li>   
                    </ul>                    
                  </div>
                </div>
        ...
        <div id="footer">
            ...
            <span>&copy; <? echo date("Y"); ?> <strong>Beta MuOnline</strong><br />
              P&aacute;gina gerada em: {#Time} secs.</span>          </div>
        </div>
	</div>
</body></html>