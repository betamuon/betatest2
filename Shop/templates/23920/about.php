...
<html dir="ltr" xml:lang="en-gb" xmlns="http://www.w3.org/1999/xhtml" lang="en-gb"><head>
  ...
  <meta name="keywords" content="MuOnline, Shopping">
  <meta name="description" content="MuOnline Shop - Sistema de vendas de itens.">
	...
	<td valign="top">
        ...
        <div class="content-text">
			...
			<td colspan="2" class="article_indent" valign="top">
                ...
                O servidor <em>Beta MuOnline</em> disponibiliza a loja como um meio
                fácil
                para o usuário adquirir itens e serviços dentro do jogo. Este
                meio é fundamental para a arrecadação de dinheiro para ajudar
                a manter o servidor sempre online. Comprando na loja, você declara
                estar ciente de que o servidor não se responsabiliza por itens
                e/ou contas que foram roubadas dentro do servidor, pois quem
                faz a segurança da conta é o próprio dono, sendo assim, o servidor
                se compromete somente a prestar suporte caso haja alguma falha
                no sistema.
                </p>
			</td>
			</tr>
...
<td>                                                                        <?php
        ...
        <div id="footer">
            ...
            <span>&copy; <? echo date("Y"); ?> <strong>Beta Shop</strong><br />
